...
<html>
	...
	<body>
		...
		<div id="list-book" class="content scaffold-list span8" role="main">
			...
			<table class="table table-striped table-bordered table-condensed">
				<thead>
					<tr>
						...
						<g:sortableColumn class="header" property="bookIconUrl" title="${message(code: 'book.bookIconUrl.label', default: 'Book Icon Url')}" />
					
						<g:sortableColumn class="header" property="bookName" title="${message(code: 'book.bookName.label', default: 'Book Name')}" />
					
						<g:sortableColumn class="header" property="bookNumber" title="${message(code: 'book.bookNumber.label', default: 'Book Number')}" />
					
						<g:sortableColumn class="header" property="bookSize" title="${message(code: 'book.bookSize.label', default: 'Book Size')}" />
					
						<g:sortableColumn class="header" property="dateCreated" title="${message(code: 'book.dateCreated.label', default: 'Date Created')}" />
